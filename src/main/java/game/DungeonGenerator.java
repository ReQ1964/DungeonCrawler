...
public class DungeonGenerator {
    private static DungeonGenerator instance = null; // Singleton instance
    ...
    public void generateDungeon(int width, int height, Player player) {
    ...
    private CombatRoom createCombatRoom(String name, String description, Random rand, int x, int y) {
    ...
    private TreasureRoom createTreasureRoom(String name, String description, Random rand, int x, int y) {
        List<LivingCreature> enemies = generateRandomEnemies(rand);
        enemies.add(new GoblinEnemy(40 + rand.nextInt(21), 3 + rand.nextInt(3)));
    ...
    private List<LivingCreature> generateRandomEnemies(Random rand) {
